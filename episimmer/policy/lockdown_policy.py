...
from episimmer.policy.testing_policy import TestResult
...
class TestingBasedLockdown(LockdownPolicy):
    ...
    def get_agent_test_result(self, agent: Agent,
                              time_step: int) -> Union[None, str]:
        """
    ...
    def get_accumulated_test_result(self, history: List[TestResult],
    ...
    def set_schedule_time(self, agents: Dict[str, Agent],
