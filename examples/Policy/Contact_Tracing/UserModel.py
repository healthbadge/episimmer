...
class UserModel(model.StochasticModel):
	def __init__(self):
		...
		self.set_transition('Susceptible', 'Infected', self.p_infection(probabilityOfInfection_fn,None))	#Adding S-> I transition which is redundant in this case as we use the event_contribute and event_receive function
