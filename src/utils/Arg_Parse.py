...
def parse_args():
    ...
    arg_parser.add_argument(
        '-np', '--noplot', dest='noplot', action='store_false', default=True,
    ...
    arg_parser.add_argument(
        '-a', '--animate', dest='animate', action='store_true', default=False,
    ...
    arg_parser.add_argument(
        '-viz', '--vizdyn', dest='viz_dyn', action='store_true', default=False,
        help=
